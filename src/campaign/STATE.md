...
Écrire `store.py` : le magasin à deux familles avec **relecture défensive champ par champ qui ne lève jamais**. Commencer par le test qui corrompt systématiquement chaque champ d'une entrée et vérifie qu'aucune exception ne remonte. C'est le cœur du spike n°6.
