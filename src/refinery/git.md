...
`refinery: <ce que ça fait>` en minuscules, sans point final · uniquement du travail dont les tests passent ·
uniquement `src/refinery/` et `tests/doubles/refinery.py`.
